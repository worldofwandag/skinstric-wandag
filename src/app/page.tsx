  ...
  return (
    <div className="max-sm:scale-[0.75] max-sm:origin-center max-sm:p-6">
      <div className="flex flex-col items-center justify-center h-[71dvh] md:fixed md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2">
        ...
        {/* Main Heading - Set initial opacity to 0 for the animation */}
        <div 
          id="main-heading"
        ...
        >
          <h1 className="text-[60px] text-[#1A1B1C] lg:text-[100px] font-inter font-normal tracking-tighter leading-none opacity-0">
            Sophisticated
            <br />
            <span className="block text-[#1A1B1C]">
              skincare
            </span>
          </h1>
        </div>
        ...
        {/* Client Component for Animations - Regular import is sufficient since ClientAnimationWrapper is already marked with "use client" */}
